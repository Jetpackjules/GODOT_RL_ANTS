...
@export var n_rays := 16.0 setget set_n_rays # (float,2, 36,2.0)
@export var ray_length := 200 setget set_ray_length # (float,5,200,5.0)
@export var cone_width := 360.0 setget set_cone_width # (float,5,360,5.0)
